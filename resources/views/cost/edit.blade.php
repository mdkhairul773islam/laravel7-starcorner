        ...
        <div class="body_content">
            <div class="panel_container">
                ...
                <div class="panel_body">
                    <form action="{{route('admin.cost.update')}}" method="POST">
                        @csrf
                        ...
                        <div class="form-group row">
                            <label class="col-form-label text-right col-3">Cost Category</label>
                            <div class="col-5">
                        ...
                        <div class="form-group row">
                            <label class="col-form-label text-right col-3">Cost Field</label>
                            <div class="col-5">
                        ...
                        <div class="form-group row mt-3">
                            <label class="col-3 col-form-label text-right">Cost By</label>
                            <div class="col-5">
                                <input type="text" class="form-control" name="costby" placeholder="Cost By">
                            </div>
                        </div>
