                            ...
                            @if($results->isNotEmpty())
                                ...
                                <tr>
                                    ...
                                    <td class="operation_btn text-right print_hide">
                                        ...
                                        <a href="{{route('admin.cost.field-destroy', $row->id)}}"
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                <form action="{{route('admin.cost.field-store')}}" method="POST">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title">Cost Field</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="form-label">Cost Field <span class="text-danger">*</span></label>
        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                <form action="{{route('admin.product.field-update')}}" method="POST">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title">Edit Cost Field</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
...
@push('footer-script')
    <script>
        function editData(id) {
            ...
            $.ajax({
                type: "POST",
                url: "{{route('admin.cost.field-edit')}}",
                data: {id: id},
                dataType: 'json',
