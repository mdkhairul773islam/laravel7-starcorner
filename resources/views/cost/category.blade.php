...
@section('content')
                            ...
                            @if($results->isNotEmpty())
                                ...
                                <tr>
                                    ...
                                    <td class="operation_btn text-right print_hide">
                                        ...
                                        <a href="{{route('admin.cost.category-destroy', $row->id)}}"
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                <form action="{{route('admin.cost.category-store')}}" method="POST">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title">Cost Category</h5>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                <form action="{{route('admin.cost.category-update')}}" method="POST">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title">Edit Cost Category</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
...
@push('footer-script')
    <script>
        function editData(id) {
            ...
            $.ajax({
                type: "POST",
                url: "{{route('admin.cost.category-edit')}}",
                data: {id: id},
                dataType: 'json',
