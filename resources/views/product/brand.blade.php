                                ...
                                @foreach($results as $key => $row)
                                    <tr>
                                        ...
                                        <td class="operation_btn text-right print_hide">
                                            ...
                                            <a href="{{route('admin.product.brand-destroy', $row->id)}}"
            ...
            <div class="modal-content">
                <form action="{{route('admin.product.brand-update')}}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="form-label">Brand <span class="text-danger">*</span></label>
                            <input type="text" id="brandName" name="name" class="form-control modal_form" autocomplete="off" required>
                        </div>
                        <div class="text-right">
...
@push('footer-script')
    <script>
        function editData(id) {
            ...
            $.ajax({
                type: "POST",
                url: "{{route('admin.product.brand-edit')}}",
                data: {id: id},
                dataType: 'json',
