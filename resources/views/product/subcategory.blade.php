...
@section('content')
                            ...
                            @if($results->isNotEmpty())
                                ...
                                <tr>
                                    ...
                                    <td class="operation_btn text-right print_hide">
                                        ...
                                        <a href="{{route('admin.product.subcategory-destroy', $row->id)}}"
                ...
                <form action="{{route('admin.product.subcategory-store')}}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control modal_form" autocomplete="off"
                                   required>
                        </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                <form action="{{route('admin.product.subcategory-update')}}" method="POST">
                    @csrf
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="form-label">Subcategory <span class="text-danger">*</span></label>
                            <input type="text" id="subcategoryName" name="name" class="form-control modal_form" autocomplete="off" required>
                        </div>
                        <div class="text-right">
...
@push('footer-script')
    <script>
        function editData(id) {
            ...
            $.ajax({
                type: "POST",
                url: "{{route('admin.product.subcategory-edit')}}",
                data: {id: id},
                dataType: 'json',
