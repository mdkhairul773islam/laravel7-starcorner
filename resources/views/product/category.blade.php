...
@section('content')
                ...
                <form action="{{route('admin.product.category-store')}}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control modal_form" autocomplete="off" required>
                        </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                <form action="{{route('admin.product.category-update')}}" method="POST">
                    @csrf
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="form-label">Category <span class="text-danger">*</span></label>
                            <input type="text" id="cateogryName" name="name" class="form-control modal_form" autocomplete="off" required>
                        </div>
                        <div class="text-right">
