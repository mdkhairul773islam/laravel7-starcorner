                                    ...
                                    <div class="password_form">
                                        ...
                                        <form action="#" method="POST">
                                            <div class="form-group row">
                                                <label class="col-form-label text-md-right required col-md-3">Full Name</label>
                                                <div class="col-md-9">
                                                    <input type="text" name="name" placeholder="Your Full Name" class="form-control" autocomplete="off" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-form-label text-md-right col-md-3">Mobile</label>
                                                <div class="col-md-9">
                                                    <input type="tel" name="mobile" placeholder="Without +88"class="form-control" autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-form-label text-md-right col-md-3">Email</label>
                                                <div class="col-md-9">
                                                    <input type="email" name="email" placeholder="Your Email Address" class="form-control" autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-form-label text-md-right col-md-3">Address</label>
                                                <div class="col-md-9">
                                                    <textarea name="address" class="form-control" placeholder="Add Your Address"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-form-label text-md-right required col-md-3 ">Username</label>
                                                <div class="col-md-9">
                                                    <input type="text" name="username" placeholder="lower Case & No Space" class="form-control" autocomplete="off" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-form-label text-md-right required col-md-3">Password</label>
                                                <div class="col-md-9">
                                                    <input type="password" name="password" placeholder="Password" autocomplete="off" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-form-label text-md-right required col-md-3">Confirm Password</label>
                                                <div class="col-md-9">
                                                    <input type="password" name="confirm_password" placeholder="Confirm password" class="form-control" autocomplete="off" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-form-label text-md-right required col-md-3">Privilege</label>
                                                <div class="col-md-9">
...
@push('header-style')
    ...
    <style>
        .user_profile .header_info {justify-content: center;}
